...
public class Omnivore extends Animal {
	...
	// constuctor giving all properties of super class(Animal) & omnivorous animals
	...
	public String toString() {
		...
		return "Name: " + getName() + "  Weight: " + getWeight() + " Kg" + "  Length : " + getLength() + " meters"
				+ "  plantdiet:" + plantdiet + "  maxFoodSize:" + " kg of meat" + maxFoodSize;
	}
